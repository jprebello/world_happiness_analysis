...
World Happiness Report é uma grande pesquisa global que entrevista pessoas em mais de 160 países. A metodologia é consistente: mesmos questionários, mesmos métodos de coleta, amostras representativas por país. Isso permite comparar países ao longo do tempo.
...
É baseado principalmente na resposta da pergunta: 
"Imagine uma escada de 0 a 10 onde 10 é a melhor vida possível e 0 a pior. Onde você está hoje?"
...
## Dashboard
1. KPIs - Média de Felicidade Mundial (0-10), País Mais Feliz, País Menos Feliz

2. Filtro - Anos (2015, 2016, 2017, 2018, 2019)

3. Matrizes - Top 10 (média), Bottom 10 (média)

4. Gráfico de Barra - Média de Felicidade por Continente

5. Correlação - Correlação entre fatores explicativos e Happiness Score
